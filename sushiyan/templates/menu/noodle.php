        ...
        <div class="header__nav">
            <nav>
                <ul>
                    ...
                    <li><a href="#" class="active">Паста и WOK</a></li>
...
<main>
    <div class="container" id="grid-wrap">
        <?php 
            $cardsConnect = mysqli_query($connect, "SELECT * FROM `nudles-and-wok`");
            $cardsCount = mysqli_num_rows($cardsConnect);
            for($i = 1; $i<=$cardsCount; $i++){
                $cardsCon = mysqli_query($connect, "SELECT * FROM `nudles-and-wok` WHERE `id` = '$i'");
