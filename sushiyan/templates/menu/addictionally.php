        ...
        <div class="header__nav">
            <nav>
                <ul>
                    ...
                    <li><a href="/templates/menu/sushi.php">Суши</a></li>
                    <li><a href="/templates/menu/noodle.php">Паста и WOK</a></li>
                    <li><a href="#" class="active">Дополнительно</a></li>
                </ul>
                <div class="cabinet">
...
<main>
    <div class="container" id="grid-wrap">
        <?php 
            $cardsConnect = mysqli_query($connect, "SELECT * FROM `addictionally`");
            $cardsCount = mysqli_num_rows($cardsConnect);
            for($i = 1; $i<=$cardsCount; $i++){
                $cardsCon = mysqli_query($connect, "SELECT * FROM `addictionally` WHERE `id` = '$i'");
