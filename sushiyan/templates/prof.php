...
<body id="profBody">
        ...
        <div class="container">
            <div class="header__nav">
                <nav>
                    ...
                    <div class="cabinet">
                        <a href="/templates/prof.php" class="profile profActive" id="profile">
    ...
    <main class="prof" id="profLogin">
        <div class="container">
            <div class="container__signIn">
                <h2>Войти</h2>
                <p>ПИН-код прийдет вам на СМС по номеру:</p>
                <form action="/assets/vender/profile/signIn.php" method="post">
                    <input type="tel" name="tel" placeholder="+7(___)___-__-__" required autofocus pattern="^[+][0-9][0-9]{3}[0-9]{3}[0-9]{2}[0-9]{2}$" maxlength="12">
